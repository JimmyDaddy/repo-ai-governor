...
- Status: active
- Stream: `stream-project-114-sprint-003`
...
- Plan: `.repo-ai-governor/context/dev/project-114-vscode-plugin-full-ownership-and-zero-cli-user-path/sprint-003-adopt-host-verify-upgrade-service-native-cutover/plan.md`
- Tasks: `.repo-ai-governor/context/dev/project-114-vscode-plugin-full-ownership-and-zero-cli-user-path/sprint-003-adopt-host-verify-upgrade-service-native-cutover/tasks/`
- Checklist: `.repo-ai-governor/context/dev/project-114-vscode-plugin-full-ownership-and-zero-cli-user-path/sprint-003-adopt-host-verify-upgrade-service-native-cutover/tasks/checklist.md`
- CSV: `.repo-ai-governor/context/dev/project-114-vscode-plugin-full-ownership-and-zero-cli-user-path/sprint-003-adopt-host-verify-upgrade-service-native-cutover/tasks/tasks.csv`
- Review: `.repo-ai-governor/context/dev/project-114-vscode-plugin-full-ownership-and-zero-cli-user-path/sprint-003-adopt-host-verify-upgrade-service-native-cutover/review/`
- Note: `2026-04-18` 已完成 `project-114 / sprint-002-doctor-check-and-workspace-bootstrap-cutover` closeout，并激活 `sprint-003-adopt-host-verify-upgrade-service-native-cutover` 作为新的 primary execution surface；后续 sprint-004 ~ sprint-005 保持 planned follow-up streams，默认 review 输出路径锁定到当前 active sprint 的 `review/`。

## Active Streams

- `stream-project-114-sprint-003`: project=`project-114-vscode-plugin-full-ownership-and-zero-cli-user-path`, sprint=`sprint-003-adopt-host-verify-upgrade-service-native-cutover`, docs=`.repo-ai-governor/context/dev/project-114-vscode-plugin-full-ownership-and-zero-cli-user-path`, plan=`.repo-ai-governor/context/dev/project-114-vscode-plugin-full-ownership-and-zero-cli-user-path/sprint-003-adopt-host-verify-upgrade-service-native-cutover/plan.md`, tasks=`.repo-ai-governor/context/dev/project-114-vscode-plugin-full-ownership-and-zero-cli-user-path/sprint-003-adopt-host-verify-upgrade-service-native-cutover/tasks/`, checklist=`.repo-ai-governor/context/dev/project-114-vscode-plugin-full-ownership-and-zero-cli-user-path/sprint-003-adopt-host-verify-upgrade-service-native-cutover/tasks/checklist.md`, csv=`.repo-ai-governor/context/dev/project-114-vscode-plugin-full-ownership-and-zero-cli-user-path/sprint-003-adopt-host-verify-upgrade-service-native-cutover/tasks/tasks.csv`, review=`.repo-ai-governor/context/dev/project-114-vscode-plugin-full-ownership-and-zero-cli-user-path/sprint-003-adopt-host-verify-upgrade-service-native-cutover/review/`, status=`active`
