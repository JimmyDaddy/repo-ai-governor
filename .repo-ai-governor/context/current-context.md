...
- Task records: `.repo-ai-governor/context/dev/project-037-agent-invoke-liveness-and-timeout-governance-rollout/sprint-002-cross-adapter-liveness-rollout-and-diagnostics/tasks/`
- Review records: `.repo-ai-governor/context/dev/project-037-agent-invoke-liveness-and-timeout-governance-rollout/sprint-002-cross-adapter-liveness-rollout-and-diagnostics/review/`
- Note: `sprint-001` 已完成并移入 completed history；当前主面聚焦 `sprint-002` 的剩余 rollout 收口（当前主要未完成项为 `TK-489`），并为 `sprint-003` 的 Codex graceful interrupt cutover 准备输入。

## Active Streams

- `primary`: project=`project-037-agent-invoke-liveness-and-timeout-governance-rollout`, sprint=`sprint-002-cross-adapter-liveness-rollout-and-diagnostics`, docs=`.repo-ai-governor/context/dev/project-037-agent-invoke-liveness-and-timeout-governance-rollout`, plan=`.repo-ai-governor/context/dev/project-037-agent-invoke-liveness-and-timeout-governance-rollout/sprint-002-cross-adapter-liveness-rollout-and-diagnostics/plan.md`, tasks=`.repo-ai-governor/context/dev/project-037-agent-invoke-liveness-and-timeout-governance-rollout/sprint-002-cross-adapter-liveness-rollout-and-diagnostics/tasks/`, checklist=`.repo-ai-governor/context/dev/project-037-agent-invoke-liveness-and-timeout-governance-rollout/sprint-002-cross-adapter-liveness-rollout-and-diagnostics/tasks/checklist.md`, csv=`.repo-ai-governor/context/dev/project-037-agent-invoke-liveness-and-timeout-governance-rollout/sprint-002-cross-adapter-liveness-rollout-and-diagnostics/tasks/tasks.csv`, review=`.repo-ai-governor/context/dev/project-037-agent-invoke-liveness-and-timeout-governance-rollout/sprint-002-cross-adapter-liveness-rollout-and-diagnostics/review/`, status=`active`, note=`Active cross-adapter rollout stream for remaining project-037 implementation work; TK-502/TK-503/TK-504/TK-488 are closed and TK-489 is the primary open runtime task`

## Planned Follow-Up Streams

- `followup-project-037-sprint-003`: project=`project-037-agent-invoke-liveness-and-timeout-governance-rollout`, sprint=`sprint-003-graceful-interrupt-cutover-and-governance-closeout`, docs=`.repo-ai-governor/context/dev/project-037-agent-invoke-liveness-and-timeout-governance-rollout`, plan=`.repo-ai-governor/context/dev/project-037-agent-invoke-liveness-and-timeout-governance-rollout/sprint-003-graceful-interrupt-cutover-and-governance-closeout/plan.md`, tasks=`.repo-ai-governor/context/dev/project-037-agent-invoke-liveness-and-timeout-governance-rollout/sprint-003-graceful-interrupt-cutover-and-governance-closeout/tasks/`, checklist=`.repo-ai-governor/context/dev/project-037-agent-invoke-liveness-and-timeout-governance-rollout/sprint-003-graceful-interrupt-cutover-and-governance-closeout/tasks/checklist.md`, csv=`.repo-ai-governor/context/dev/project-037-agent-invoke-liveness-and-timeout-governance-rollout/sprint-003-graceful-interrupt-cutover-and-governance-closeout/tasks/tasks.csv`, review=`.repo-ai-governor/context/dev/project-037-agent-invoke-liveness-and-timeout-governance-rollout/sprint-003-graceful-interrupt-cutover-and-governance-closeout/review/`, status=`planned`, note=`Planned Codex-specific graceful interrupt closeout plus diagnostics cutover, budget matrix, regression governance, and project closeout package`
