...
- Docs root: `.repo-ai-governor/context/dev/project-064-vscode-packaged-secondary-surface-rollout`
- Task records: `.repo-ai-governor/context/dev/project-064-vscode-packaged-secondary-surface-rollout/sprint-001-packaged-distribution-and-extension-host-smoke/tasks/`
- Review records: `.repo-ai-governor/context/dev/project-064-vscode-packaged-secondary-surface-rollout/sprint-001-packaged-distribution-and-extension-host-smoke/review/`
- Note: `2026-04-08` 已通过 `CR-005 / TK-703 / DA-703` 完成 `project-067` final closeout，并按固定顺序激活 `project-064 / sprint-001`；`CR-001 / TK-704 / DA-704` 已完成 sprint clean closeout，当前 surface 继续保留给 `project-064` project-final CR loop。

## Active Streams

- `active-1`: role=`primary`, project=`project-064-vscode-packaged-secondary-surface-rollout`, sprint=`sprint-001-packaged-distribution-and-extension-host-smoke`, docs=`.repo-ai-governor/context/dev/project-064-vscode-packaged-secondary-surface-rollout`, plan=`.repo-ai-governor/context/dev/project-064-vscode-packaged-secondary-surface-rollout/sprint-001-packaged-distribution-and-extension-host-smoke/plan.md`, tasks=`.repo-ai-governor/context/dev/project-064-vscode-packaged-secondary-surface-rollout/sprint-001-packaged-distribution-and-extension-host-smoke/tasks/`, checklist=`.repo-ai-governor/context/dev/project-064-vscode-packaged-secondary-surface-rollout/sprint-001-packaged-distribution-and-extension-host-smoke/tasks/checklist.md`, csv=`.repo-ai-governor/context/dev/project-064-vscode-packaged-secondary-surface-rollout/sprint-001-packaged-distribution-and-extension-host-smoke/tasks/tasks.csv`, review=`.repo-ai-governor/context/dev/project-064-vscode-packaged-secondary-surface-rollout/sprint-001-packaged-distribution-and-extension-host-smoke/review/`, status=`active`, note=`project-064 sprint-001 implementation + delegated sprint CR are clean; sprint surface is retained for the project-final CR loop`
