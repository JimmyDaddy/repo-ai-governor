...
|---|---|---|---|---|---|
| TK-401 | sprint-001 | 无子命令入口分流与 session-shell runner 基线 | cli/entry-shell | `.repo-ai-governor/draft/interactive-cli-session-first-agent-shell-technical-solution.md` | planned |
| TK-402 | sprint-001 | transcript / composer / prompt-bar React 组件 | cli/session-ui | TK-401 | planned |
| TK-403 | sprint-001 | slash command registry 与推荐过滤器 | cli/command-palette | TK-401,TK-402 | planned |
| TK-404 | sprint-001 | `stderr-only` / fallback / non-interactive contract 回归与退出语义固化 | verification/gates | TK-401,TK-402,TK-403 | planned |
| TK-405 | sprint-002 | `orchestration-service-client` session DTO 与 service-owned contract 基线 | runtime/session-contract | TK-404 | planned |
| TK-406 | sprint-002 | sidecar host session runtime 与 `session.main` route dispatch | runtime/session-runtime | TK-405 | planned |
| TK-407 | sprint-002 | CLI session client、transcript store、`/resume` 与顶层 `resume` 命令 | cli/session-resume | TK-405,TK-406 | planned |
| TK-408 | sprint-002 | 多轮对话、错误恢复、cancellation 与 desktop-ready streaming parity | runtime/session-parity | TK-406,TK-407 | planned |
| TK-409 | sprint-003 | `/init / connect / doctor / workspace / workflow` handoff | cli/command-handoff | TK-408 | planned |
| TK-410 | sprint-003 | `/run / plan / review` handoff 与 live-result bridge | cli/command-handoff | TK-409 | planned |
| TK-411 | sprint-003 | command preview / confirm / execute UX | cli/command-preview | TK-409,TK-410 | planned |
| TK-412 | sprint-003 | transcript 内 command result summary / artifact backlink | cli/session-reporting | TK-410,TK-411 | planned |
| TK-413 | sprint-004 | session settings commands 与 deferred command naming 收口 | cli/session-settings | TK-412 | planned |
| TK-414 | sprint-004 | multiline / history / search UX 与 `!` passthrough / `"query"` 启动入口 | cli/session-ux | TK-413 | planned |
| TK-415 | sprint-004 | i18n / help / docs / adoption playbook 与全能力可发现性收口 | docs/adoption | TK-413,TK-414 | planned |
| TK-416 | sprint-004 | desktop sidecar smoke baseline 与 session DTO packaged-surface 校验 | verification/desktop-smoke | TK-414,TK-415 | planned |
