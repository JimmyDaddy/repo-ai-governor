...
| TK-137 | sprint-001 | Codex 远端 provider 真实调用与凭据/health 契约 | implementation/adapter | TK-136,DA-136 | in_progress |
| TK-138 | sprint-001 | GitHub Copilot 远端 provider 真实调用与 capability truthfulness 收口 | implementation/adapter | TK-136,DA-136 | planned |
