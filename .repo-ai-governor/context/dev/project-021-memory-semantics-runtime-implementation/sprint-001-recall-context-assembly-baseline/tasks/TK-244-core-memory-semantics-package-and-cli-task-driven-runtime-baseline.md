...
2. `pnpm exec vitest run apps/cli/test/runtime/task-driven-run-runtime.test.ts --maxWorkers=1 --maxConcurrency=1`
3. `pnpm exec vitest run packages/core-memory-semantics/test/**/*.test.ts --maxWorkers=1 --maxConcurrency=1`
