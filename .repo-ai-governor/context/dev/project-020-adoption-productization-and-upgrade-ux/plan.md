...
11. 2026-03-27：激活 `project-018 / sprint-005-memory-semantics-module-promotion-cutover` 后，`project-020 / sprint-004` 已从 `current-context` closeout surface 迁入 `completed-streams-history.md`。
