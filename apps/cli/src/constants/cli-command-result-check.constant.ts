...
export enum CliCommandResultCheckId {
  ...
  ADOPT_RECEIPT = 'adopt_receipt',
  SELF_HOST_RUN_PREFLIGHT = 'self_host_run_preflight',
...
export const CLI_PRETTY_KEY_CHECK_IDS = new Set<string>([
  ...
  CliCommandResultCheckId.SELF_HOST_RUN_PREFLIGHT,
  CliCommandResultCheckId.HOST_ACTION,
  CliCommandResultCheckId.HOST_TARGET,
