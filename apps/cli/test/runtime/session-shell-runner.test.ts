      ...
      ...(viewModel.commandProgressPanel
        ? {
            commandProgressPanel: {
              ...
              logEntries: viewModel.commandProgressPanel.logEntries.map((entry) => ({
                ...entry,
              })),
...
const DEFAULT_TRANSLATIONS: Record<string, string> = {
  ...
  'cli.sessionShell.mentions.roles.generic.summary': 'Discussion with configured role {{roleId}}.',
  'cli.sessionShell.mentions.roles.planner.summary': 'Planning discussion.',
  'cli.sessionShell.mentions.roles.architect.summary': 'Architecture discussion.',
  'cli.sessionShell.mentions.roles.reviewer.summary': 'Review discussion.',
  'cli.sessionShell.mentions.roles.verifier.summary': 'Verification discussion.',
  ...
  'cli.reactShell.progress.logs.level.debug': 'DEBUG',
  'cli.reactShell.progress.logs.level.info': 'INFO',
  'cli.reactShell.progress.logs.level.success': 'SUCCESS',
  'cli.reactShell.progress.logs.level.warning': 'WARN',
  'cli.reactShell.progress.logs.level.error': 'ERROR',
