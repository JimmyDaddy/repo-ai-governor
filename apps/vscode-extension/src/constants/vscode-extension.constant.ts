...
export const VSCODE_EXTENSION_COMMAND_IDS = {
  ...
  MUTATE_WORKFLOW_DRAFT: 'repoAiGovernor.mutateWorkflowDraft',
  VALIDATE_WORKFLOW_DRAFT: 'repoAiGovernor.validateWorkflowDraft',
  COMMIT_WORKFLOW_DRAFT: 'repoAiGovernor.commitWorkflowDraft',
