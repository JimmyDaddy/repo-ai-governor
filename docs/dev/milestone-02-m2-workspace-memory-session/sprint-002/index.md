...
完成规范记忆源、执行态记忆源、共享 session 与审计字段补齐。

## Tasks

1. [tasks/TK-211.md](./tasks/TK-211.md): normative_knowledge_sources 接入
2. [tasks/TK-212.md](./tasks/TK-212.md): operational state source 接入
3. [tasks/TK-213.md](./tasks/TK-213.md): 共享 execution_session_id 事件总线
