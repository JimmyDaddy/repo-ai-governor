...
完成 DSL/IR、Policy Gate、HITL 决策与恢复模型。

## Tasks

1. [tasks/TK-301.md](./tasks/TK-301.md): DSL/IR: Sequential/Parallel/Loop/Condition
2. [tasks/TK-302.md](./tasks/TK-302.md): Process Compiler 校验与产物
3. [tasks/TK-303.md](./tasks/TK-303.md): Policy Gate 规则与阈值
