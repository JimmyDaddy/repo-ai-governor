...
1. [tasks/TK-501.md](./tasks/TK-501.md): tests/contract 全量覆盖关键契约
2. [tasks/TK-502.md](./tasks/TK-502.md): tests/integration 与 tests/e2e 主链路
3. [tasks/TK-503.md](./tasks/TK-503.md): 依赖边界检查切换为 blocking gate
