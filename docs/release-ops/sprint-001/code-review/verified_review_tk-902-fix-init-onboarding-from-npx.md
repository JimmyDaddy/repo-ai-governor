...
1. 已核对 [init-command.js](/Users/jimmydaddy/study/repo-ai-governor/src/commands/init-command.js)，确认新增 npx 场景依赖自安装逻辑与官方 skills 自动安装流程。
2. 已核对 [command-registry.js](/Users/jimmydaddy/study/repo-ai-governor/src/cli/command-registry.js)，确认 `init` 暴露 `--self-install`、`--skip-self-install`、`--skip-skill-install` 选项。
3. 已核对 [init-documents.js](/Users/jimmydaddy/study/repo-ai-governor/src/commands/templates/init-documents.js)，确认 `.repo-ai-governor` 关键目录模板文件已提供中英文内容。
